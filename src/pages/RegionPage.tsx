        ...
        <div>
          ...
          <p className="text-gray-400 text-lg max-w-2xl">
            ...
            {locationInfo?.postcode && (
              <span className="text-gray-500"> Postcode: {locationInfo.postcode}</span>
            )}
          </p>
            ...
            {expiredJobs.length > 0 && (
              <div className="flex items-center gap-2 text-sm">
                <span className="text-gray-500">
                  <span className="text-white font-bold">{expiredJobs.length}</span> Expired
                </span>
              </div>
            )}
          </div>
        ...
        {jobs.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-sm mb-6">
              No job listings available for this region yet. Check back later or browse other regions.
            </p>
                  ...
                  {expiredJobs.map((job: Job) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="px-1.5 py-0.5 rounded text-[7px] font-bold bg-red-500/10 text-red-400 uppercase">
                              EXPIRED
                            </span>
                          </div>
